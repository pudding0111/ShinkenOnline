...
class FakeStrategyBattleScreen extends StatefulWidget {
  @override
  _FakeStrategyBattleScreenState createState() => _FakeStrategyBattleScreenState();
}

class _FakeStrategyBattleScreenState extends State<FakeStrategyBattleScreen>  with SingleTickerProviderStateMixin {
...
//リアクション変数
  ...
  void specificSceneFunc (String nowScene){
    ...
    List<Map<String, dynamic>> availableCards =
      ...
      setState(() {
        enemyBattleHand = enemyCards[_enemyBattleCardIndex]['type'] ?? 'rock';
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // SvgPicture.asset(
            //       'Images/' + rank + '.svg',
            //       height:  min (screenHeight * 0.1, screenWidth * 0.3),
            //       width: min (screenHeight * 0.1, screenWidth * 0.3), // 画面幅に応じたサイズ設定
            //       fit: BoxFit.contain,
            //     ),
            // ボタンの背景画像
            Row(
