...
class RealRandomBattleScreen extends StatefulWidget {
  @override
  _RealRandomBattleScreenState createState() => _RealRandomBattleScreenState();
}

class _RealRandomBattleScreenState extends State<RealRandomBattleScreen>  with SingleTickerProviderStateMixin {
    ...
    if (updateTime != null) {
      ...
      if (delayDuration > 0) {
        ...
        Future.delayed(Duration(milliseconds: delayDuration), () {
          print('checkRoom: Time reached. Navigating to RealRandomBattle...');
...
double _calculateWinRate(int winCount, int battleTime) {
  ...
  _loadSkillList() async {
    ...
    setState(() {
      mySkillNoList = (prefs.getStringList('RandomSkillNoList') ?? ['No1', 'No2', 'No3', 'No4', 'No5', 'No6', 'No7', 'No8', 'No9', 'No10']);
